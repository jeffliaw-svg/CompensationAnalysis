...
# ─────────────────────────────────────────────────────────────────────
COPART_LOCATIONS = [
    ("Anchorage", "Anchorage", "AK", "401 W Chipperfield Dr", "99501"),
    ("Anchorage South", "Anchorage", "AK", "7533 Old Seward Hwy", "99518"),
    ("Birmingham", "Hueytown", "AL", "3101 Davey Allison Blvd", "35023"),
    ("Tanner", "Tanner", "AL", "20760 Sandy Road", "35671"),
    ("Mobile", "Eight Mile", "AL", "4763 Lott Road", "36613"),
    ("Mobile South", "Theodore", "AL", "9401 Old Pascagoula Rd", "36582"),
    ("Montgomery", "Montgomery", "AL", "6044 Troy Highway", "36116"),
    ("Dothan", "Newton", "AL", "10428 West US 84", "36352"),
    ("Little Rock", "Conway", "AR", "703 Main St", "72032"),
    ("Fayetteville", "Prairie Grove", "AR", "15976 Bill Campbell Rd", "72753"),
    ("Phoenix", "Phoenix", "AZ", "615 S 51st Ave", "85043"),
    ("Tucson", "Tucson", "AZ", "5600 S Arcadia Ave", "85706"),
    ("Los Angeles", "Los Angeles", "CA", "8423 S Alameda St", "90001"),
    ("Sun Valley", "Sun Valley", "CA", "11409 Penrose St", "91352"),
    ("Van Nuys", "Van Nuys", "CA", "7519 Woodman Ave", "91405"),
    ("Rancho Cucamonga", "Rancho Cucamonga", "CA", "12167 Arrow Rte", "91739"),
    ("Colton", "Colton", "CA", "1203 S Rancho Ave", "92324"),
    ("San Diego", "San Diego", "CA", "7847 Airway Rd", "92154"),
    ("Bakersfield", "Bakersfield", "CA", "2216 Coy Avenue", "93307"),
    ("Fresno", "Fresno", "CA", "1255 East Central", "93725"),
    ("San Martin", "San Martin", "CA", "13895 Llagas Ave", "95046"),
    ("Vallejo", "Vallejo", "CA", "282 Fifth Street", "94590"),
    ("Hayward", "Hayward", "CA", "1964 Sabre Street", "94545"),
    ("Martinez", "Martinez", "CA", "2701 Waterfront Rd", "94553"),
    ("Sacramento", "Sacramento", "CA", "8600 Morrison Creek Dr", "95828"),
    ("Antelope", "Antelope", "CA", "8650 Antelope North Rd", "95843"),
    ("Napa", "American Canyon", "CA", "1660 Green Island Rd", "94503"),
    ("Redding", "Anderson", "CA", "4603 Locust Road", "96007"),
    ("Fairfield", "Fairfield", "CA", "4665 Business Center Dr", "94534"),
    ("Denver", "Brighton", "CO", "1281 County Rd 27", "80603"),
    ("Denver Central", "Denver", "CO", "6464 Downing St", "80229"),
    ("Colorado Springs", "Colorado Springs", "CO", "640 Winters Dr", "80907"),
    ("Littleton", "Littleton", "CO", "8300 Blakeland Dr", "80125"),
    ("Hartford", "New Britain", "CT", "138 Christian Lane", "06051"),
    ("Hartford Springfield", "East Granby", "CT", "49 Russell Road", "06026"),
    ("Seaford", "Seaford", "DE", "26029 Bethel Concord Rd", "19973"),
    ("Jacksonville North", "Jacksonville", "FL", "10200 Alton Box Rd", "32218"),
    ("Jacksonville East", "Jacksonville", "FL", "5007 New Kings Rd", "32209"),
    ("Jacksonville West", "Jacksonville", "FL", "450 Hammond Blvd", "32220"),
    ("Tampa South", "Riverview", "FL", "12020 US Highway 301 S", "33578"),
    ("Orlando North", "Apopka", "FL", "3352 W Orange Blossom Trl", "32712"),
    ("Orlando", "Orlando", "FL", "307 East Landstreet Rd", "32824"),
    ("Ocala", "Ocala", "FL", "7100 NW 44 Ave", "34482"),
    ("Miami South", "Homestead", "FL", "24301 SW 137th Ave", "33032"),
    ("Miami North", "Miami", "FL", "12850 NW 27th Ave", "33054"),
    ("Miami Central", "Miami", "FL", "11858 NW 36th Ave", "33167"),
    ("West Palm Beach", "West Palm Beach", "FL", "7876 Belvedere Rd", "33411"),
    ("Fort Pierce", "Fort Pierce", "FL", "2601 Center Road", "34946"),
    ("Tallahassee", "Midway", "FL", "1825 Commerce Blvd", "32343"),
    ("Punta Gorda", "Punta Gorda", "FL", "5017 Duncan Road", "33982"),
    ("Punta Gorda South", "Arcadia", "FL", "10175 U.S. 17", "34269"),
    ("Atlanta West", "Austell", "GA", "2568 Old Alabama Rd", "30168"),
    ("Atlanta East", "Loganville", "GA", "6089 Hwy 20", "30052"),
    ("Atlanta South", "Ellenwood", "GA", "761 Clark Dr", "30294"),
    ("Atlanta North", "Gainesville", "GA", "1602 Athens Highway", "30507"),
    ("Cartersville", "Cartersville", "GA", "1880 Hwy 113", "30120"),
    ("Savannah", "Savannah", "GA", "5510 Silk Hope Rd", "31405"),
    ("Tifton", "Tifton", "GA", "399 Oakridge Church Rd", "31794"),
    ("Augusta", "Augusta", "GA", "3810 Hensley Rd", "30906"),
    ("Macon", "Byron", "GA", "304 Smith Road", "31008"),
    ("Fairburn", "Fairburn", "GA", "6737 Roosevelt Hwy", "30213"),
    ("Honolulu", "Kapolei", "HI", "91-542 Awakumoku St", "96707"),
    ("Boise", "Nampa", "ID", "3716 N Middleton Rd", "83687"),
    ("Chicago North", "Elgin", "IL", "1475 Bluff City Blvd", "60120"),
    ("Chicago South", "Chicago Heights", "IL", "89 E Sauk Trail", "60411"),
    ("Wheeling", "Wheeling", "IL", "110 East Palatine Rd", "60090"),
    ("Southern Illinois", "Cahokia Heights", "IL", "99 Racehorse Dr", "62205"),
    ("Peoria", "Pekin", "IL", "14417 VFW Rd", "61554"),
    ("Indianapolis", "Indianapolis", "IN", "4040 Office Plaza Blvd", "46254"),
    ("Fort Wayne", "Hartford City", "IN", "696 East State Rd 26", "47348"),
    ("Dyer", "Dyer", "IN", "641 Joliet St", "46311"),
    ("Evansville", "Evansville", "IN", "800 E Virginia St", "47711"),
    ("Des Moines", "Des Moines", "IA", "3300 Vandalia Rd", "50317"),
    ("Eldridge", "Eldridge", "IA", "451 Blackhawk Trail Rd", "52748"),
    ("Kansas City", "Kansas City", "KS", "6211 Kansas Ave", "66111"),
    ("Wichita", "Wichita", "KS", "2648 S West St", "67217"),
    ("Louisville", "Louisville", "KY", "3100 Pond Station Rd", "40272"),
    ("Lexington East", "Lexington", "KY", "5801 Kasp Ct", "40509"),
    ("Lexington West", "Lawrenceburg", "KY", "1051 Industry Rd", "40342"),
    ("Walton", "Walton", "KY", "13273 Dixie Highway", "41094"),
    ("Earlington", "Earlington", "KY", "700 N Sandcut Rd", "42410"),
    ("New Orleans", "New Orleans", "LA", "14600 Old Gentilly Rd", "70129"),
    ("Baton Rouge", "Greenwell Springs", "LA", "21595 Greenwell Springs Rd", "70739"),
    ("Shreveport", "Shreveport", "LA", "5235 Greenwood Rd", "71109"),
    ("Lyman", "Lyman", "ME", "136 Kennebunk Pond Rd", "04002"),
    ("Windham", "Windham", "ME", "11 Bedrock Terrace", "04062"),
    ("Baltimore", "Finksburg", "MD", "2251 Old Westminster Pike", "21048"),
    ("Baltimore East", "Baltimore", "MD", "601 W Patapsco Ave", "21225"),
    ("Washington DC", "Waldorf", "MD", "11055 Billingsley Rd", "20602"),
    ("North Boston", "North Billerica", "MA", "55R High St", "01862"),
    ("South Boston", "Mendon", "MA", "82 Cape Road", "01756"),
    ("West Warren", "West Warren", "MA", "600 Old West Warren Rd", "01092"),
    ("Freetown", "Assonet", "MA", "170 S Main St", "02702"),
    ("Detroit", "Woodhaven", "MI", "21000 Hayden Dr", "48183"),
    ("Flint", "Davison", "MI", "5000 N State Rd", "48423"),
    ("Ionia", "Portland", "MI", "8460 S State Rd", "48875"),
    ("Lansing", "Lansing", "MI", "3902 South Canal Rd", "48917"),
    ("Kincheloe", "Kincheloe", "MI", "5030 W Kincheloe Rd", "49788"),
    ("Wayland", "Wayland", "MI", "1261 142nd Ave", "49348"),
    ("Minneapolis", "Fridley", "MN", "3737 E River Rd", "55421"),
    ("Minneapolis North", "Ham Lake", "MN", "1526 Bunker Lake Blvd", "55304"),
    ("St Cloud", "Avon", "MN", "200 County Rd 159", "56310"),
    ("Jackson", "Florence", "MS", "205 S Rankin Industrial Dr", "39073"),
    ("Grenada", "Grenada", "MS", "15673 Highway 8", "38901"),
    ("Springfield", "Rogersville", "MO", "2889 E US Highway 60", "65742"),
    ("St Louis", "Bridgeton", "MO", "13033 Taussig Ave", "63044"),
    ("Columbia", "Columbia", "MO", "8485 Richland Rd", "65201"),
    ("Kansas City MO", "Kansas City", "MO", "1420 S 55th St", "66106"),
    ("Billings", "Billings", "MT", "1090 Island Park Rd", "59101"),
    ("Helena", "Helena", "MT", "3333 Bozeman Ave", "59601"),
    ("Lincoln", "Greenwood", "NE", "13603 238th St", "68366"),
    ("Las Vegas", "Las Vegas", "NV", "4810 N Lamb Blvd", "89115"),
    ("North Las Vegas", "North Las Vegas", "NV", "3441 Clayton St", "89032"),
    ("Reno", "Reno", "NV", "9915 N Virginia St", "89506"),
    ("Candia", "Candia", "NH", "134 Raymond Rd", "03034"),
    ("Somerville", "Hillsborough", "NJ", "2124 W Camplain Rd", "08844"),
    ("Trenton", "Windsor", "NJ", "108 North Main St", "08561"),
    ("Glassboro West", "Glassboro", "NJ", "781 Jacob Harris Ave", "08028"),
    ("Glassboro East", "Glassboro", "NJ", "200 Grove St", "08028"),
    ("Albuquerque", "Albuquerque", "NM", "7705 Broadway Blvd SE", "87105"),
    ("Newburgh", "Marlboro", "NY", "25 Riverview Dr", "12542"),
    ("Syracuse", "Central Square", "NY", "46 Zuk-Pierce Rd", "13036"),
    ("Long Island", "Brookhaven", "NY", "1983 Montauk Hwy", "11719"),
    ("Rochester", "Leroy", "NY", "4 West Ave", "14482"),
    ("Albany", "Albany", "NY", "1916 Central Ave", "12205"),
    ("Buffalo", "Angola", "NY", "8418 Southwestern Blvd", "14006"),
    ("Raleigh", "Dunn", "NC", "310 Copart Rd", "28334"),
    ("Raleigh North", "Raleigh", "NC", "6400 Old Smithfield Rd", "27603"),
    ("Concord", "Concord", "NC", "7940 US Highway 601 S", "28025"),
    ("Lumberton", "Lumberton", "NC", "4019 NC 72 Hwy W", "28360"),
    ("Gastonia", "Gastonia", "NC", "3060 Fairview Dr", "28052"),
    ("China Grove", "China Grove", "NC", "1081 Recovery Rd", "28023"),
    ("Mebane", "Mebane", "NC", "1870 US 70 Hwy", "27302"),
    ("Bismarck", "Bismarck", "ND", "3700 Apple Creek Rd", "58504"),
    ("Columbus", "Columbus", "OH", "1680 Williams Rd", "43207"),
    ("Cleveland East", "Northfield", "OH", "286 E Twinsburg Rd", "44067"),
    ("Cleveland West", "Columbia Station", "OH", "34417 E Royalton Rd", "44028"),
    ("Dayton", "Moraine", "OH", "4691 Springboro Pike", "45439"),
    ("Cincinnati", "Cincinnati", "OH", "4568 Muhlhauser Rd", "45011"),
    ("Oklahoma City", "Oklahoma City", "OK", "2829 SE 15th St", "73129"),
    ("Tulsa", "Tulsa", "OK", "2408 W 21st St", "74107"),
    ("Portland North", "Portland", "OR", "6900 NE Cornfoot Dr", "97218"),
    ("Portland South", "Woodburn", "OR", "2885 National Way", "97071"),
    ("Eugene", "Eugene", "OR", "29815 E Enid Rd", "97402"),
    ("Philadelphia", "Pennsburg", "PA", "2704 Geryville Pike", "18073"),
    ("Philadelphia East", "Chalfont", "PA", "77 Bristol Road", "18914"),
    ("Harrisburg", "Grantville", "PA", "8 Park Drive", "17028"),
    ("York Haven", "York Haven", "PA", "795 Sipe Rd", "17370"),
    ("Chambersburg", "Chambersburg", "PA", "2962 Lincoln Way W", "17202"),
    ("Pittsburgh South", "West Mifflin", "PA", "526 Thompson Run Rd", "15122"),
    ("Pittsburgh North", "Ellwood City", "PA", "2000 River Road", "16117"),
    ("Pittsburgh East", "Adamsburg", "PA", "133 Asphalt Lane", "15611"),
    ("Altoona", "Ebensburg", "PA", "4007 Admiral Peary Hwy", "15931"),
    ("Scranton", "Duryea", "PA", "210 Mcalpine St", "18642"),
    ("Exeter", "Exeter", "RI", "10 Industrial Dr", "02822"),
    ("Columbia SC", "Gaston", "SC", "4324 Hwy 321 S", "29053"),
    ("North Charleston", "Harleyville", "SC", "120 Commerce Dr", "29448"),
    ("Spartanburg", "Spartanburg", "SC", "1922 Nazareth Church Rd", "29301"),
    ("Rapid City", "Rapid City", "SD", "2170 Seger Dr", "57701"),
    ("Nashville", "Lebanon", "TN", "865 Stumpy Lane", "37090"),
    ("Memphis", "Memphis", "TN", "5545 Swinnea Rd", "38118"),
    ("Knoxville", "Madisonville", "TN", "6355 B Hwy 411", "37354"),
    ("Houston", "Houston", "TX", "1655 Rankin Road", "77073"),
    ("Houston East", "Houston", "TX", "2535 West Lake Houston Pkwy", "77339"),
    ("Dallas", "Grand Prairie", "TX", "505 Idlewild Rd", "75051"),
    ("Dallas South", "Wilmer", "TX", "1701 East Beltline Rd", "75172"),
    ("Fort Worth", "Haslet", "TX", "950 Blue Mound Rd W", "76052"),
    ("San Antonio", "San Antonio", "TX", "11130 Applewhite Rd", "78224"),
    ("Austin", "New Braunfels", "TX", "8725 IH-35 N", "78130"),
    ("Corpus Christi", "Corpus Christi", "TX", "3200 Agnes St", "78405"),
    ("Amarillo", "Amarillo", "TX", "3999 S Loop 335 E", "79118"),
    ("Abilene", "Abilene", "TX", "2630 FM 3034", "79601"),
    ("El Paso", "Anthony", "TX", "501 Valley Chili Rd", "79821"),
    ("McAllen", "Mercedes", "TX", "301 Mile 1 East", "78570"),
    ("Lufkin", "Lufkin", "TX", "3700 Old Union Rd", "75904"),
    ("Longview", "Longview", "TX", "3046 Highway 322 S", "75603"),
    ("Waco", "Temple", "TX", "7201 N General Bruce Dr", "76501"),
    ("Andrews", "Andrews", "TX", "1975 SW 860", "79714"),
    ("Salt Lake City North", "North Salt Lake", "UT", "170 W Center St", "84054"),
    ("Salt Lake City", "Magna", "UT", "7320 W 2100 S", "84044"),
    ("Farr West", "Farr West", "UT", "3586 N 2000 W", "84404"),
    ("Rutland", "Center Rutland", "VT", "29 Old Route 4A", "05736"),
    ("Richmond", "Sandston", "VA", "5701 Whiteside Rd", "23150"),
    ("Fredericksburg", "Fredericksburg", "VA", "4717 Massaponax Church Rd", "22408"),
    ("Charles City", "Charles City", "VA", "6300 Chambers Rd", "23030"),
    ("Danville", "Chatham", "VA", "12360 US Hwy 29", "24531"),
    ("Hampton", "Hampton", "VA", "16 Nettles Lane", "23666"),
    ("North Seattle", "Arlington", "WA", "16701 51st Ave NE", "98223"),
    ("Graham", "Graham", "WA", "21421 Meridian E", "98338"),
    ("Pasco", "Pasco", "WA", "3333 N Railroad Ave", "99301"),
    ("Spokane", "Airway Heights", "WA", "11019 W Mcfarlane Rd", "99001"),
    ("Charleston", "Hurricane", "WV", "1746 US Rte 60", "25526"),
    ("Milwaukee", "Cudahy", "WI", "4825 S Whitnall Ave", "53110"),
    ("Madison", "Madison", "WI", "5448 Lien Rd", "53718"),
    ("Milwaukee North", "Milwaukee", "WI", "9201 N 107th St", "53224"),
    ("Appleton", "Appleton", "WI", "2500 American Dr", "54914"),
    ("Casper", "Casper", "WY", "1998 Oil Field Center Rd", "82604"),
]
